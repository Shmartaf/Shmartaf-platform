...
const UserForm = () => {
    ...
    return (
        <Form form={form} onFinish={onFinish} layout="vertical">
            ...
            {isParent && (
                <>
                    <Form.Item label="Parent Description" name="parentDescription" required>
                        <TextArea />
                    </Form.Item>
                    <Button
                        type="dashed"
                        ...
                        {(fields, { remove }) => (
                            <>
                                {fields.map(({ key, name, fieldKey, ...restField }) => (
                                    <div key={key}>
                                        <Form.Item
                                            label={`Child ${fields.length === 1 ? '' : key + 1} Full Name`}
                                            {...restField}
                                            name={[name, 'fullName']}
                                        ...
                                        <Form.Item
                                            label={`Child ${fields.length === 1 ? '' : key + 1} Birthdate`}
                                            {...restField}
                                            name={[name, 'birthdate']}
                                        ...
                                        <Form.Item
                                            label={`Child ${fields.length === 1 ? '' : key + 1} Needs`}
                                            {...restField}
                                            name={[name, 'needs']}
                                        ...
                                        <Form.Item
                                            label={`Child ${fields.length === 1 ? '' : key + 1} gender`}
                                            {...restField}
                                            name={[name, 'gender']}
            ...
            {isBabysitter && (
                <>
                    ...
                    <Form.Item label="Babysitter Description" name="babysitterDescription" required>
                        <TextArea />
                    </Form.Item>
                </>
            )}
